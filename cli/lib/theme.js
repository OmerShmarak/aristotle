...
export function printHelp() {
  ...
  console.log(colors.muted('  serve <book-dir> [--port N] [--no-open]: serve a built book with'));
  console.log(colors.muted('    ask-the-book (select text in the browser to ask / fix chapters).\n'));
  ...
  console.log(colors.muted('    aristotle serve artifacts/diffusion_models\n'));
}
