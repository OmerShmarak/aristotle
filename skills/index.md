...
| Architectural Diagrams | `skills/renderers/architectural-diagrams.md` | Precise building plans, sections, assembly details, load/water/service paths, and controlled axonometric or exploded views via SVG.js. Use when the teaching insight depends on spatial arrangement, layer continuity, interfaces, or construction sequence. Prefer section/detail views over generic boxes-and-arrows for physical building systems. |
